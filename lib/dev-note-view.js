    ...
    this.selectList = new SelectListView(
      {
        ...
        didConfirmSelection: (note) => {
          ...
          if(this.delete_note_after){
            ...
            if(markers.length){
              atom.workspace.open(markers[0].editor.getPath())
              markers[0].editor.setSelectedBufferRange(markers[0].marker.getBufferRange(), {autoscroll: false})
              markers[0].editor.scrollToCursorPosition()
            }
